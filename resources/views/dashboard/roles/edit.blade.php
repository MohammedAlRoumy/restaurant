...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-info">
            ...
            @enderror
            <form class="form-horizontal" method="post" action="{{route('dashboard.roles.update',$role->id)}}">
                @csrf
                @method('put')
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" value="{{ old('name', $role->name) }}"  placeholder="أسم الصلاحية">
                        </div>
                    </div>
                </div>
