    ...
    <section class="content">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title" style="float: right;">تعديل بيانات الطاولة</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            @error('name')
            ...
            @enderror
            <form class="form-horizontal" method="post" action="{{route('dashboard.tables.update',$table->id)}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="tableNumber" min="1" value="{{old('tableNumber',$table->tableNumber)}}" class="form-control" placeholder="رقم الطاولة">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="chairs" min="1" value="{{old('chairs',$table->chairs)}}" class="form-control" placeholder="عدد مقاعد الطاولة">
                        </div>
                    </div>
